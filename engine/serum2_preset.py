...
_SERUM2_DEFAULT_PROCESSOR_STATE = bytes.fromhex(
    ...
    "9BB8C558C8CD9AC4804A85F557CA0947E47458C1314BD93C97CC3158D8314B90"
    "4C8CC0B958C03557C53958C9354CD3FC9790804A87F99BB9055C890987E47C53"
    "90859CB08887AC705BC7C158D0C15C55495BCA4D5AB4884D84788AC3744B86F8"
    ...
    "9F1050D0D06BEC118841F3CC23C6D0D9A767B4357C2215661F9C21C14F71CD8"
    "224882A4A9B373B2A3DBB2215669F908505B8247240647C7ACC156A1F90C73F5"
    "E4F1BC7021761235DC6791551A9F004A216BAF96542DA244CB3627A4614767D1"
    "1924612B61FF8150D3EC51A02B15DC38B09A2A501101240C00748F36B133496"
    "1961461FE06514792388D94504502107CF33C8DDBA6EB4750BA78C73E76D2348"
    "DB2E1B3168CA248043A48A26CBCD7C918A7D2502107CF308F3BD655733FE73FD"
    "23CF2D2D97D33AC07E8A7B24FAA8AB9D68B7BCDAF53916261F0800030CF3FF52"
    "05713DAA904EC91F7A66D50A1BEA7B88152978E4E3989308A2B95F10CEACF7B1"
    "5942B61F1FFF3C13C06470915C254D4DF393F8A8E8CF2ADA588DB763C980F669"
    "B2E1B356AB466C54458787DC57ADAE6F3CF05A4B85C51966056B453BBF544B5C"
    "C35B6053C566BDF40EE6FF3CF365BC2CB6BAFDE7D55587A9ED2BE97F3FEA0457"
    "AA93ABAB4D498863877E476EC3F8E0AE50227FBB9BE8DAC4344AD6EECC722BA3"
    "54779E8EABD5EAED44A1943B5DF6DB35357E6FC69705A8A2EAE6ACEA9FFCD648"
    "54B4AE89E85CE9C25320B34EB30F5ADD3B9B34CB7A5A18486B6576CE97802EE4"
    "CF96AC33BA93F8DEB84B0767D92F419B55394C1DF89C529C1D00D00D08E38E14"
    "79FCC465308A0247F3575F77EF3CF7E7BD840F3CFFE07C036344F7228494F4AD"
    "9BD009FFD73693C3228F6C7B393031CD8504C5352FE5AF4B02E4A0568B4E9042"
    "047F747EC088D00578556B546E5B5F2E34E571E666662C4226ECDF34CBE5AB26"
    "261F92909FC0E8DDB1C05A15C6A1AE824E10E8332CFFD4105E2636003C22CD21"
    "FFD892E4186BDD4D9D85A9A9CE2E2C92FA19848EDB71F2AF80704896D52FE1DC"
    "3FF91B7C2240A0DD76158121B555CBBB12DFCF953FCD5E599B996567F63A245A"
    "5094122DACF6D65224ED1070B5740A11FD14E2BE4E931B1A9012E3C1100A2922"
    "FE1DF52972B86623ADF39CEEA5BF13B00A72A26590F0D817C47EC8B8573C8E54"
    "B46487E6D527FA194C97CCFF5FF1987338821F2A9CEBDC0AB90EF668519E8AAF"
    "787CABC0003005FE80D003CAC569A5220ADD248ADE5F09F095439656DD61C1CA"
    "49E0F99B7A7524B8C35C3DB8FC0BD47E27E2AC38EF1B4E155982DF4F8B42118"
    "463318016E37B59B3B85BB10B2BF418D730FA3B"
)

_SERUM2_DEFAULT_CONTROLLER_STATE = bytes.fromhex(
    "5D8558C68CDBBB817FE82FFFFFFFFFFFFBDD84BD5AB00D9AB5495ACC884D84BD"
    "5AB5099BBB015A908987AC705980C199867887BD7C8C890497D0F08C90C498C3"
    "F08B904897BDB89885054CE0F14D8C8498BCF887AC705BC54D5B91058FD10199"
    ...
    "B43887AC745CC70947E47059CD019BCA8C8AB9F99890899B90CD5AC50D5BB4BD"
    ...
    "54A2F3EF051C21495EADAA1FFFC97AE9F406A116F23E75B9C5DDB1C89D673B85"
    ...
    "DB395E9D6D8E91811FDBAB8DEB6A91093F300956E135086FA4619E4C82522CB41"
    "521E572F299D041A385D3FDEBC6399BFC0E8E24EE9F8403BD46F3704494DB31DA"
    "32FBD869A6E08295D7735E02"
)
...
class SerumPreset:
    ...
    def get_processor_state(self) -> bytes:
        ...
        Returns the real Serum 2 VST3 IComponent binary state (captured from
        the plugin via pedalboard).  The default init-patch state is used;
        Serum 2 loads with its init sound, and the user-installed preset is
        available in the Serum 2 browser under User/DUBFORGE/.
        """
        return _SERUM2_DEFAULT_PROCESSOR_STATE

    def get_controller_state(self) -> bytes:
        """Return bytes for Ableton ALS ``<ControllerState>`` embedding.

        Returns the real Serum 2 VST3 IEditController binary state (captured
        from the plugin via pedalboard).  Paired with the processor state,
        this ensures ``Restore 1`` succeeds when Ableton opens the ALS.
        """
        return _SERUM2_DEFAULT_CONTROLLER_STATE
