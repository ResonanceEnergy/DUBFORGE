...
def kill_noise_sources():
    ...
    try:
        ...
        if hasattr(mastering_chain, "DITHER_ENABLED"):
            mastering_chain.DITHER_ENABLED = False
    except ImportError:
        pass
    ...
    try:
        ...
        if hasattr(noise_generator, "DEFAULT_GATE_DB"):
            noise_generator.DEFAULT_GATE_DB = -55.0
    except ImportError:
        pass
    ...
    try:
        ...
        if hasattr(riser_synth, "MAX_NOISE_GAIN"):
            riser_synth.MAX_NOISE_GAIN = 0.15
    except ImportError:
        pass
...
def set_female_vocal_chops():
    ...
    try:
        ...
        if hasattr(vocal_chop, "PITCH_RANGE"):
            vocal_chop.PITCH_RANGE = (55, 75)  # MIDI range: G2–D#4
        if hasattr(vocal_chop, "FORMANT_PRESERVE"):
            vocal_chop.FORMANT_PRESERVE = True
        if hasattr(vocal_chop, "VOICE_TYPE"):
            vocal_chop.VOICE_TYPE = "female"
    except ImportError:
        pass
